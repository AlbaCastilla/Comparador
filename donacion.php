...
<body>
    ...
    <div class="modal">
        ...
        <!--CAJAS PAYPAL, GMAIL Y APPLE PAY-->
        ...
        <!--FORMULARIO DONACIÓN TARJETA-->

            <div class="separador">
                <hr class="linea">
                <p>o con tarjeta de crédito</p>
                <hr class="linea">
            </div>
            <div class="tarjeta-de-credito-info">
                <div class="contenedor-datos">
                    <label for="" class="titulo-datos">Titular de la tarjeta</label>
                    <input class="celdas" type="text" name="titular-tarjeta" placeholder="Introduce tú número completo">
                </div>
                <div class="contenedor-datos">
                    <label for="" class="titulo-datos">Número de la tarjeta</label>
                    <input class="celdas" type="number" name="numero-tarjeta" placeholder="0000 0000 0000 0000">
                </div>
                <div class="contenedor-datos">
                    <label for="" class="titulo-datos">Fecha de Caducidad / CVV</label>
                    <div class="datos-detras">
                        <input class="celdas" type="text" name="fecha-caducidad" placeholder="01/24">
                        <input class="celdas" type="number" name="cvv" placeholder="CVV">
                    </div>
                </div>
            </div>
            <button class="btn-donacion">Donación</button>
        </form>
    </div>
