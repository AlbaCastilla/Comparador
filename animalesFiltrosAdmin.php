    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        tarjetasAnimales.forEach(function(tarjeta) {
            tarjeta.addEventListener('click', function() {
                // Remover la clase 'animal-seleccionado' de todas las tarjetas
                tarjetasAnimales.forEach(function(tarjeta) {
                    tarjeta.classList.remove('animal-seleccionado');
                    tarjeta.style.border = 'none';
                });

                // Agregar la clase 'animal-seleccionado' a la tarjeta seleccionada
                tarjeta.classList.add('animal-seleccionado');
                ...
                // Guardar el nombre del animal seleccionado en un campo oculto
                document.getElementById('nombreAnimalSeleccionado').value = nombreAnimal;

                // Mostrar el nombre del animal seleccionado en la consola
...
<button class="button-izquierdo-inferior" onclick="mostrarFormulario()">Modificar Animal</button>
